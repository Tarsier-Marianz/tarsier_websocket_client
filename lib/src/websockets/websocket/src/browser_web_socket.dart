...
class BrowserWebSocket implements WebSocket {
  ...
  static Future<BrowserWebSocket> connect(Uri url,
    ...
    final webSocket = html.WebSocket(url.toString(),
    ...
    if (webSocket.readyState == html.WebSocket.OPEN) {
      webSocketConnected.complete(browserSocket);
    } else {
      if (webSocket.readyState == html.WebSocket.CLOSING ||
          webSocket.readyState == html.WebSocket.CLOSED) {
