...
class HtmlWebSocketChannel extends StreamChannelMixin
  ...
  final html.WebSocket innerWebSocket;
  ...
  HtmlWebSocketChannel(Object /*WebSocket*/ webSocket)
      : innerWebSocket = webSocket as html.WebSocket {
    _readyCompleter = Completer();
    if (innerWebSocket.readyState == html.WebSocket.OPEN) {
      _readyCompleter.complete();
      _listen();
    } else {
      if (innerWebSocket.readyState == html.WebSocket.CLOSING ||
          innerWebSocket.readyState == html.WebSocket.CLOSED) {
  ...
  void _innerListen(html.MessageEvent event) {
