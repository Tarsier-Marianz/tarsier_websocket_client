...
import 'package:tarsier_websocket_client/src/websockets/websocket_client/src/_web_socket_channel/_web_socket_channel.dart'
    if (dart.library.io) 'package:tarsier_websocket_client/src/websockets/websocket_client/src/_web_socket_channel/_web_socket_channel_io.dart'
    if (dart.library.js_interop) 'package:tarsier_websocket_client/src/websockets/websocket_client/src/_web_socket_channel/_web_socket_channel_html.dart';
import 'package:tarsier_websocket_client/src/websockets/websocket_client/src/_web_socket_connect/_web_socket_connect.dart'
    if (dart.library.io) 'package:tarsier_websocket_client/src/websockets/websocket_client/src/_web_socket_connect/_web_socket_connect_io.dart'
    if (dart.library.js_interop) 'package:tarsier_websocket_client/src/websockets/websocket_client/src/_web_socket_connect/_web_socket_connect_html.dart';
import 'package:tarsier_websocket_client/src/websockets/websocket_client/src/connection.dart';
